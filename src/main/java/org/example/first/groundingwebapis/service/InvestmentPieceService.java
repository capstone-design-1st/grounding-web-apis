        ...
        if(request.getType().equals("ESTATES")){
            pieceInvestmentRepository.save(
                    new PieceInvestment(
                            ...
                            ,request.getPricePerUnit(), request.getInvestmentPoint(), request.getAssetType(), request.getEntryStatus(), request.getDesiredPrice(), request.getPiece_count(), request.getLeaseStartDate(),request.getLeaseEndDate(), request.getAssetImage() , userId
                    )
            );
        }else{
            pieceInvestmentRepository.save(
                    new PieceInvestment(
                            ...
                            ,request.getRecommendedUse(), request.getDesiredPrice(),request.getPricePerUnit(),request.getInvestmentPoint(), request.getLandImageRegistration(), request.getPiece_count(), request.getLeaseStartDate(),request.getLeaseEndDate(), request.getAssetImage(), userId
                    )
            );
        }
    }
